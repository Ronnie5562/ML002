...
index1 = np.array([3, 6, 8]) # 3,6 and 9 indicates the index of the required elements in an array.
INT_A = Row_Matrix[index1]  # Now, A contains the values of Row_Matrix that are in indexes 3,6 and 9. This is the basic concept of Advanced Indexing
print(INT_A)
